...
from constants import SNAKE_SPEED,FRUIT_CREATION_TIME,CAPTION, SNAKE_COLOUR, SNAKE_START_POSITION, KEY_TO_DIRECTION, WINDOW_SIZE, BACKGROUND_COLOUR
    ...
    for event in pygame.event.get():
        if event.type == pygame.KEYDOWN:
            if event.key in KEY_TO_DIRECTION:
                ...
                current_direction = move_increment  # Update direction
